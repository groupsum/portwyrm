...
PostgreSQL restart persistence have executable coverage. External ACME, MySQL restart conformance,
verified multi-architecture publication, and formal SSOT certification remain fail-closed release

...
export default function HostDialog({
  ...
  const buildDraftHost = (): Host => {
    ...
    return {
      ...(editingHost || {id: 'draft', ownerId: '', ownerName: '', provenanceKind: 'human', managedBy: null, status: 'pending', administrativeState: 'enabled', deploymentState: 'pending', reachabilityState: 'unknown', checkedAt: null, latencyMs: null, httpStatus: null, probePhase: null, probeError: null, created: '', modified: '', lastError: null, activeGeneration: 0}),
      type: hostType,
